    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1>Welcome to the Video Game Collection Tracker</h1>
                <br />
                <h2>You can start by heading over to the games tab to start adding games to your collection or you can go straight to your profile and edit your profile picture.</h2>
            </div>
            <!-- /.container-fluid -->
        </div>
        <!-- End of Main Content -->
