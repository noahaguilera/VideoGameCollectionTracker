    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <table width="60%">
                    <tr>
                        <td><img class="bigcircle"
                                 src="${user.profilePicture}"></td>
                        <td><!-- Page Heading -->
                    ...
                    <tr>
                        <td>
                            <form action="changeProfilePicture" method="POST">
                                <input type="text" id="profilePicture" name="pictureInput" placeholder="example.png" value="">
                                <input type="submit" name="changePicture" value="Change Profile Picture"/>
                            </form>
                        </td>
                    </tr>
                </table>
