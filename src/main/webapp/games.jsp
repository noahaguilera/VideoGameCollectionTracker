    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <a href="addgame.jsp">Don't See a game? Click here to add one!</a>

                    <c:forEach items="${games}" var="gameList">
                <table width="100%" class="gametable">
                        <tr>
                            <td rowspan="3" class="gameimg"><img id="cover" src="${gameList.cover}"></td>
                            <td><h1>${gameList.title}</h1></td>
                        ...
                        <tr>
                            <td colspan="2">${gameList.description}</td>
                        </tr>
                        <tr>
                            <td>Rated: ${gameList.rating}</td>
                        </tr>
                        </table>
                    </c:forEach>
